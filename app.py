...
# Modulo Cartella Farmaci (📂)
if not odi_df.empty:
    st.sidebar.divider()
    st.sidebar.success(f"📂 **Cartella Farmaci: {len(odi_df)}**")
    with st.sidebar.expander("Vedi Farmaci Correlati"):
...
st.caption("MAESTRO Suite | v17.0 Full Restore | RUO")
