...
# Se df contiene un errore, mostrali subito
...
# --- AGGIUNTA: LISTA FARMACI CORRELATI NELLA SIDEBAR ---
if not odi_df.empty:
    st.sidebar.divider()
    st.sidebar.markdown("### 💊 Farmaci Correlati (ODI)")
    # Estraiamo i nomi unici dei farmaci
    drug_list = odi_df["Generic_Name"].unique()
    for drug in drug_list:
        st.sidebar.markdown(f"- **{drug}**")
